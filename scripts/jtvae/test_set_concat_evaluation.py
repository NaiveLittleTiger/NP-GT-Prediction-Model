...
# load data using  jtvae as small molecular representation
...
def draw_picture(df,name=""):
    ...
    #save dataframe
    df_mean.to_csv("../../results/test_set_seed/jtvae/df_mean.csv")
    df_sem.to_csv("../../results/test_set_seed/jtvae/df_sem.csv")
    ...
    plt.savefig("../../results/test_set_seed/jtvae/%s_test_seed_plot_methods.png" %name)
    ...
    plt.savefig("../../results/test_set_seed/jtvae/%s_test_seed_plot_metrics.png" %name)

if __name__ == "__main__":
    # make picture jtvae
    study_path="../../data/optuna_study/jtvae-batch/"
    output_data_path = "../../results/test_set_seed/jtvae/"
