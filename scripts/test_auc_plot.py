...
def train_kfold_csv():
    ...
    cv_score_mean.to_csv("../results/kfold/cv_score_mean.csv")
    cv_score_sem.to_csv("../results/kfold/cv_score_sem.csv")
...
def test_kfold_csv():
    ...
    test_set_result.iloc[:, :-1].transpose().plot(kind='bar', ylim=(0, 1),
                                                                          ...
                                                                          figsize=(12, 12), fontsize=22)
    test_set_result.to_csv("../results/kfold/innner_test_set_plot_metrics.csv")
    plt.legend(loc=3, prop={'size': 18})
    plt.title('test_set_plot_metrics', fontsize=20)
    plt.savefig("../results/test_set/test_set_plot_metrics.png")
...
def test_auc():
    ...
    plt.savefig("../results/test_set/test_set_plot_auc_roc.png")
...
def external_test_set(X_external,y_external,name):
    ...
    plt.savefig("../results/test_set/%s_external_test_set_plot_metrics.png" % (name))
