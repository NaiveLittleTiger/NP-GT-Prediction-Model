...
# load data
X_train = np.load("../../data/splits/maccs/X_train.npy")
y_train = np.load("../../data/splits/maccs/y_train.npy")
y_train = y_train.ravel()
X_test= np.load("../../data/splits/maccs/X_test.npy")
y_test=np.load("../../data/splits/maccs/y_test.npy")
y_test = y_test.ravel()
# load external test set
X_Berry = np.load("../../data/splits/maccs/X_Berry.npy")
y_Berry = np.load("../../data/splits/maccs/y_Berry.npy")
X_Oat = np.load("../../data/splits/maccs/X_Oat.npy")
y_Oat = np.load("../../data/splits/maccs/y_Oat.npy")
...
def train_kfold_csv():
    ...
    cv_score_mean.to_csv("../../results/kfold/maccs/cv_score_mean.csv")
    cv_score_sem.to_csv("../../results/kfold/maccs/cv_score_sem.csv")
    ...
    plt.savefig("../../results/kfold/maccs/CV_plot_methods.png")
    ...
    plt.savefig("../../results/kfold/maccs/CV_plot_metrics.png")
...
def test_kfold_csv():
    ...
    test_set_result.iloc[:, :-1].transpose().plot(kind='bar', ylim=(0, 1),
                                                                          ...
                                                                          figsize=(12, 12), fontsize=22)
    test_set_result.to_csv("../../results/kfold/maccs/innner_test_set_plot_metrics.csv")
    plt.legend(loc=3, prop={'size': 18})
    plt.title('test_set_plot_metrics', fontsize=20)
    plt.savefig("../../results/kfold/maccs/test_set_plot_metrics.png")
...
def test_auc():
    ...
    plt.savefig("../../results/kfold/maccs/test_set_plot_auc_roc.png")
...
def external_test_set(X_external,y_external,name):
    ...
    test_set_result.iloc[:, :-1].transpose().plot(kind='bar', ylim=(0, 1),
                                                  rot=0, stacked=False, legend=False,
                                                  figsize=(12, 12), fontsize=22)
    test_set_result.to_csv("../../results/kfold/maccs/%s_external_test_set_plot_metrics.csv" % (name))
    plt.legend(loc=3, prop={'size': 18})
    plt.title(' %s external test set results ' % (name), fontsize=20)
    plt.savefig("../../results/kfold/maccs/%s_external_test_set_plot_metrics.png" % (name))
