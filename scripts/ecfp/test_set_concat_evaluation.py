...
# load data using  ecfp as small molecular representation
dataDir="../../data/splits/ecfp/"
...
def draw_picture(df,name=""):
    ...
    #save
    df_mean.to_csv("../../results/test_set_seed/ecfp/df_mean.csv")
    df_sem.to_csv("../../results/test_set_seed/ecfp/df_sem.csv")
    ...
    plt.savefig("../../results/test_set_seed/ecfp/%s_test_seed_plot_methods.png" %name)
    ...
    plt.savefig("../../results/test_set_seed/ecfp/%s_test_seed_plot_metrics.png" %name)

if __name__ == "__main__":
    # make picture ecfp
    study_path="../../data/optuna_study/ecfp-batch/"
    output_data_path = "../../results/test_set_seed/ecfp/"
